package Document::Doc::vSolrMetadataAPI::Schema_LS_8;

=head1 NAME

Document::vSolrMetadataAPI::Schema_LS_8

=head1 DESCRIPTION

This class creates an VuFind Solr type 8 schema document for indexing
