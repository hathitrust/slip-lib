package Document::Doc::vSolrMetadataAPI::Schema_LS_5;

=head1 NAME

Document::vSolrMetadataAPI::Schema_LS_5

=head1 DESCRIPTION

This class creates an VuFind Solr type 5 schema document for indexing
