package Document::Doc::vSolrMetadataAPI::Schema_LS_6;

=head1 NAME

Document::vSolrMetadataAPI::Schema_LS_6

=head1 DESCRIPTION

This class creates an VuFind Solr type 6 schema document for indexing
